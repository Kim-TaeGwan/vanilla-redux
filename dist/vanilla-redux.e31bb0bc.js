...
var DECREASE = "DECREASE"; // 액션 이름을 사용하여 액션 객체를 만드는 생성 함수를 작성해 준다.
...
var store = (0, _redux.createStore)(reducer); // render는 상태가 업데이트될 때 마다 호출되며, 리액트의 render 함수와는 다르게 이미 html을 사용하여 만들어진 UI의 속성을 상태에 따라 변경해 준다.
...
render(); // vanilla js 에서는 subscribe함수를 직접 사용하지만,
